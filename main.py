...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "facerecognition-46d78.appspot.com"
})
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    offset = (414 - text_width) // 2
                    # Putting the text on the background image
                    cv2.putText(imgBackground, str(studentInfo['name']), (808 + offset, 445),
                                cv2.FONT_HERSHEY_COMPLEX, 1, (50, 50, 50), 1)

                    # Resizing imgStudent to match the region size
                    imgStudentResized = cv2.resize(imgStudent, (216, 216))
                    # Assigning the resized image to the target region in imgBackground
